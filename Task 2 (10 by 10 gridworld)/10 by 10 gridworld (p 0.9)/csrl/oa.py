...
class OmegaAutomaton:
    ...
    def ltl2oa(self,ltl):
        ...
        #C:/Users/juncli/OneDrive/POMDPs Folder/csrl-master/csrl
        
        #check_output(['C:\\Users\\juncli\\OneDrive\\POMDPs Folder\\csrl-master\\csrl\\ltl2ldba.bat'])
        
        
        
        
        out = check_output(['C:\\Users\\Junchao_Li\\Desktop\\POMDPs Folder\\csrl-master\\rabinizer4\\bin\\ltl2ldba.bat', '-d', '-e', ltl] if self.oa_type == 'ldba' else ['C:\\Users\\Junchao_Li\\Desktop\\POMDPs Folder\\csrl-master\\rabinizer4\\bin\\ltl2dra.bat', '-c', ltl])
